# الملف المرجعي الشامل لتصميم وتطوير وتوثيق مشروع «تكنولوجيا الأعلاف البديلة .. أزولا مصر»
**Master Content, UX, Design & Development Brief - v8.0**

> **بيان اعتماد:** جميع البيانات والأرقام والإحصائيات الواردة في هذا الملف معتمدة رسمياً من إدارة مشروع **«تكنولوجيا الأعلاف البديلة .. أزولا مصر»** ورعاته المؤسسيين: **برنامج المنح الصغيرة (SGP Egypt)** – **مرفق البيئة العالمية (GEF)** – **برنامج الأمم المتحدة الإنمائي (UNDP)**، وبالتعاون التنفيذي مع **جمعية الخدمات المتكاملة بكفر الدوار** ومزارع فرع **أسوان التكاملية**.

---

## 1. بطاقة التعريف الأساسية بالمشروع (Project Metadata)

* **اسم المشروع بالعربية:** تكنولوجيا الأعلاف البديلة .. أزولا مصر
* **اسم المشروع بالإنجليزية:** Azolla Egypt – Alternative Feed Technology & Sustainable Agriculture
...
---
**تم إعداد وتوثيق هذا الملف المرجعي الشامل ليكون الدليل الأساسي والمعتمد لمشروع «تكنولوجيا الأعلاف البديلة .. أزولا مصر».**
